...
// #include <UTFTGLUE.h> 
#include "SEDHOM_OS_SIMPLE_GUI.h"
#include "SEDHOM_OS_status_types.h"
...
// uint16_t Color_mode_black,Color_mode_white;
...
void WIFI_Icon(int x,int y,int range,uint16_t color_on,uint16_t color_off,int Background)
{
    ...
    Display.fillTriangle(x,y,x+21,y,x+21,y-20,Background);
...
void clear_All_Display(uint16_t color)
{
    Display.fillScreen(color); 
}
void clear_All_Display()
{
    Display.fillScreen(mode); 
}
