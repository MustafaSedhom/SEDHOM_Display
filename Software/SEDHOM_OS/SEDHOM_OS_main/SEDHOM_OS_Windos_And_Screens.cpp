...
void init_new_screen()
{
    ...
    Icon.Back_Arrow_Icon(20,30,Back_arraw_color);
}
void Depart_screen()
{
...
void new_window(word_t name_window)
{
    ...
    Display.setCursor(393,98);Display.setTextSize(3);Display.setFont(BigFont);
    Display.setTextColor(Icon.Not_mode());Display.write("X");
    Display.setCursor(100,90);Display.setTextSize(8);Display.setFont(BigFont);
    Display.setTextColor(Icon.Not_mode());Display.write(name_window);
}
...
{ 
    ...
    #define txt_rangr_wifi_color  txt_rangr_wifi_color_wifi_window //white 
    ...
    if(Is_window_1_or_window_2_wifi_window)
    {
       ...
       Display.setFont(BigFont);Display.setTextColor(BLUE);
       ...
       Icon.WIFI_Icon(310,120,map(Range_wifi_6,0,100,0,5),wifi_color_show,wifi_color_dont_show,Icon.Mode());
       Icon.WIFI_Icon(310,150,3,wifi_color_show,wifi_color_dont_show,Icon.Mode());
       Icon.WIFI_Icon(310,180,4,wifi_color_show,wifi_color_dont_show,Icon.Mode());
       Icon.WIFI_Icon(310,210,1,wifi_color_show,wifi_color_dont_show,Icon.Mode());
       Icon.WIFI_Icon(310,240,2,wifi_color_show,wifi_color_dont_show,Icon.Mode());
       Display.setFont(BigFont);Display.setTextColor(BLUE);
    ...
    else
    {
       ...
       Icon.WIFI_Icon(310,120,1/*map(Range_wifi_1,1,99,1,9)*/,wifi_color_show,wifi_color_dont_show,Icon.Mode());
       Icon.WIFI_Icon(310,150,5/*map(Range_wifi_2,1,99,1,9)*/,wifi_color_show,wifi_color_dont_show,Icon.Mode());
       Icon.WIFI_Icon(310,180,map(Range_wifi_3,1,99,1,9),wifi_color_show,wifi_color_dont_show,Icon.Mode());
       Icon.WIFI_Icon(310,210,map(Range_wifi_4,1,99,1,9),wifi_color_show,wifi_color_dont_show,Icon.Mode());
       Icon.WIFI_Icon(310,240,map(Range_wifi_5,1,99,1,9),wifi_color_show,wifi_color_dont_show,Icon.Mode());
       Display.setFont(BigFont);Display.setTextColor(txt_rangr_wifi_color);
...
void timer_screen_touch()
{
   ...
   // time name
    ...
    if(Timer_clock_is_on)
    {
       ...
       if(pixel_y > 100 && pixel_y < 100+40) {Switch_Timer_clock = OFF; Timer_clock_screen(); }}
    }
    // 310,100,40,40
}
